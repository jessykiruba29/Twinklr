...
import 'yuba-widget'; // (auto-imports style if declared correctly)
    ...
    <div className="product-container">
      {products.map(product => (
        <div key={product._id} className="product-card">
          ...
          <img src={product.image} className="im" onClick={()=>popup(product)}/>
...
<div className='c'><Button className='like' onClick={()=>popup(product)}>comments</Button></div>
    ...
    {pop && selectedImage && (
      <div className='popup'>
        ...
        <img className="comm_img" src={selectedImage.image}></img>
